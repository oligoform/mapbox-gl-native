...
template <class Writer, class T>
void stringify(Writer& writer, const CameraFunction<T>&) {
    writer.StartObject();
    // TODO
    writer.EndObject();
}
...
template <class Writer, class T>
void stringify(Writer& writer, const SourceFunction<T>&) {
    writer.StartObject();
    // TODO
    writer.EndObject();
}
...
template <class Writer, class T>
void stringify(Writer& writer, const CompositeFunction<T>&) {
    writer.StartObject();
    // TODO
    writer.EndObject();
}
